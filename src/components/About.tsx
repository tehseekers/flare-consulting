        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div>
            ...
            <div className="space-y-5 mb-10">
              <div
                ...
                style={{ background: 'rgba(201,168,76,0.04)', borderLeftColor: '#C9A84C' }}
              >
                <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#C9A84C' }}>Our Vision</p>
              ...
              <div
                className="rounded-xl p-6 border-l-4"
                style={{ background: 'rgba(30,130,200,0.04)', borderLeftColor: '#1E82C8' }}
              >
          ...
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div
                key={card.label}
                className="bg-slate-50 border border-slate-100 rounded-2xl p-7 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
